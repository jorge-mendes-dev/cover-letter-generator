export const en = {
  ...
  form: {
    ...
    resumeTabUpload: "Upload PDF",
    resumeTabPaste: "Paste text",
    resumeTextPlaceholder: "Paste your résumé text here…",
    validationNoResumeText: "Please paste your resume text.",
    ...
    pdfSalutation: "Dear Hiring Manager,",
    pdfClosing: "Best regards,",
