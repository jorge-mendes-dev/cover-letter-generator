...
export const es: Translations = {
  ...
  form: {
    ...
    resumeTabUpload: "Subir PDF",
    resumeTabPaste: "Pegar texto",
    resumeTextPlaceholder: "Pega aquí el texto de tu currículum…",
    validationNoResumeText: "Por favor, pega el texto de tu currículum.",
    ...
    resultGenerating: "Generando...",
    pdfSalutation: "Estimado/a responsable de contratación,",
    pdfClosing: "Saludos cordiales,",
