...
export const ptBR: Translations = {
  ...
  form: {
    ...
    resumeTabUpload: "Enviar PDF",
    resumeTabPaste: "Colar texto",
    resumeTextPlaceholder: "Cole o texto do seu currículo aqui…",
    validationNoResumeText: "Por favor, cole o texto do seu currículo.",
    ...
    resultDownloadPdf: "Baixar PDF",
    resultGenerating: "Gerando...",
    pdfSalutation: "Prezada equipe de recrutamento,",
    pdfClosing: "Atenciosamente,",
